...
def compute_zen_score(gpu, model, mixup_gamma, resolution, batch_size, repeat, fp16=False):
    info = {}
    nas_score_list = []
    # if gpu is not None:
...
if __name__ == "__main__":
    ...
    info = compute_zen_score(gpu=device, model=the_model, mixup_gamma=args.mixup_gamma,
